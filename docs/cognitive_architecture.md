...
План новых фич, вдохновленный Hermes Agent, находится в [hermes_inspired_feature_plan.md](hermes_inspired_feature_plan.md). Его нужно использовать как источник задач после стабилизации базового цикла.
